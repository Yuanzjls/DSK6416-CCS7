...
/*
 *  ======== dsk6416_aic23_openCodec.c ========
 *  DSK6416_AIC23_openCodec() implementation
 */
...
/* AIC23 McBSP handles */
MCBSP_Handle DSK6416_AIC23_CONTROLHANDLE;
MCBSP_Handle DSK6416_AIC23_DATAHANDLE;

/*
 *  ======== DSK6416_AIC23_openCodec ========
...
DSK6416_AIC23_CodecHandle DSK6416_AIC23_openCodec(int id, DSK6416_AIC23_Config *Config)
{
    ...
    DSK6416_AIC23_CONTROLHANDLE = MCBSP_open(MCBSP_DEV1, MCBSP_OPEN_RESET);
    if (DSK6416_AIC23_CONTROLHANDLE == INV)
        return (DSK6416_AIC23_CodecHandle)INV;
        
    /* Open codec data handle */
    DSK6416_AIC23_DATAHANDLE = MCBSP_open(MCBSP_DEV2, MCBSP_OPEN_RESET);
    if (DSK6416_AIC23_DATAHANDLE == INV)
        return (DSK6416_AIC23_CodecHandle)INV;

    /* Configure codec control McBSP */
    MCBSP_config(DSK6416_AIC23_CONTROLHANDLE, &mcbspCfgControl);
    
    /* Configure codec data McBSP */
    MCBSP_config(DSK6416_AIC23_DATAHANDLE, &mcbspCfgData);

    /* Start McBSP1 as the codec control channel */
    MCBSP_start(DSK6416_AIC23_CONTROLHANDLE, MCBSP_XMIT_START |
	    MCBSP_SRGR_START | MCBSP_SRGR_FRAMESYNC, 100);
    
    /* Reset the AIC23 */
    DSK6416_AIC23_rset(0, DSK6416_AIC23_RESET, 0);
    
    /* Configure the rest of the AIC23 registers */
    DSK6416_AIC23_config(0, Config);
